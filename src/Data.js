...
export const approachCards = [
  {
    ...
    title: "Inclusif",
    text:
      "Peu importe votre genre, votre niveau ou votre origine, l'ASBG est un espace ouvert à toutes et à tous. Nous croyons que le sport est plus beau quand il rassemble."
  },
  {
    img: card2Img,
    title: "Compétitif",
